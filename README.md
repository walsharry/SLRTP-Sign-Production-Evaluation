...
The skeleton format follows the standard used in the SLRTP CVPR 2025 Challenge. For detailed information on the format specification, visit the [challenge Skeleton Information](https://github.com/walsharry/SLRTP_Skeleton_Keypoint_information).
